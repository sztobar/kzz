module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'build', [
    ...
    'copy:build_assets', 'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss',/* 'copy:php',*/
    //'karmaconfig', 'karma:continuous',
    'copy:images', 'index:build'
  ]);
